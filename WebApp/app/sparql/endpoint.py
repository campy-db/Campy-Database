...
def query(data, url = os.getenv('SUPERPHY_RDF_URL', "http://localhost:9999/blazegraph/namespace/campy/sparql") ):
...
def ask(data, url = os.getenv('SUPERPHY_RDF_URL', "http://localhost:9999/blazegraph/namespace/campy/sparql")):
	results = query(data)
...
def update(data, url = os.getenv('SUPERPHY_RDF_URL', "http://localhost:9999/blazegraph/namespace/campy/sparql")):
	payload = {'update': data}
