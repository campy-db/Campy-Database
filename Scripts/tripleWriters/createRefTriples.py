...
def createRefTriples(df, row, isoTitle):
    ...
    if not pd.isnull(ref):
        ...
        # instance of whatever kind of animal it is,  eg cowC1004 is an instance of cow. We just
        # pray that that animal has already been set as an instance of whatever family it belongs
        # to earlier when we handled the animal source triples. If it's a human its just an
        # instance of Patient.
